...
class Base:
    ...
    def _startTraining(self):
        self._method.fit(self._train_values, self._train_labels, epochs=self._epochs, use_multiprocessing=True)
...
if __name__ == "__main__":
    ...
    if neural:
        ...
        importDataFromPostgresToSqlite()
        #remakeData()
