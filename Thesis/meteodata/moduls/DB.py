...
# inserters
    ...
    def insertMeteodata(self, data):
        ...
        self._curs.execute("INSERT INTO public.meteodata_meteodata VALUES(DEFAULT, '" + str(data[0]) + "', " + str(data[1]) + ", '" + str(data[2]) + "', " + str(data[4]) + ", " + str(data[5]) + ", " + str(data[6]) + ", " + str(data[7]) + ", '{" + str(data[8]) + "}'," + str(data[3]) + ")")
